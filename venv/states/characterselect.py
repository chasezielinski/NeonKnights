...
class CharacterSelect(BaseState):
    def __init__(self):
        ...
        self.fighter_sprites = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['images128']
        self.fighter_selected_sprites = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['images256']
        self.fighter_idle_frames = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['idle_frames']
        self.fighter_idle_speed = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['idle_speed']
        self.fighter_idle_weights = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['idle_weights']
        self.fighter_flourish_frames = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['flourish_frames']
        self.fighter_flourish_speed = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['flourish_speed']
        self.fighter_flourish_weights = settings.CHARACTER_SELECT_MENU['sprites']["Fighter"]['flourish_weights']
        self.fighter_image = self.fighter_sprites[self.fighter_idle_frames[0]]
